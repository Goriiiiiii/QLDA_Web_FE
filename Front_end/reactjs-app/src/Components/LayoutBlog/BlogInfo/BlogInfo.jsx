...
function BlogInfo(props) {
  ...
  const handleTotalDaysChange = (event) => {
    ...
    if (value < 0) {
      setTotalDaysError('Ngày yêu cầu phải lớn hơn 0');
    } else {
      setTotalDaysError('');
    }
    setTotalDays(value);
      ...
      <div className="secContainer">
        ...
        <div className="infoAdd itemDiv">
          ...
          <div className="info-item form-group info-item">
            ...
            {totalDaysError && <div className="error-message alert alert-danger">{totalDaysError}
        ...
        <div className="grid-blog">
          <div className="inputBlogDiv">
            <input className="form-control inputTag" type="text" placeholder="Nhập tag yêu cầu" onChange={handleInputChange} />
