                ...
                <div className="flex flex-col w-3/5 bg-white shadow-xl rounded-xl items-center justify-center ">
                    ...
                    <div className="flex flex-row w-2/3 items-center justify-center ">
                        <div className=" flex basis-1/3 items-center justify-center  ">
                            <label className="bg-cyan-300 rounded-md px-2 py-2 cursor-pointer text-center" onClick={toggleTypeDropdown}>Chọn loại thông báo</label>
                        </div>
                        {typeDropdown && (
                    ...
                    <div className=" flex justify-center items-center py-5">
                        <button onClick={handleSubmit} className="bg-cyan-200 rounded-xl text-zinc-500 text-lg px-16 py-2 hover:bg-cyan-700 hover:text-white ">Tạo thông báo</button>
                    </div>
